...
#define PIN_MOTOR_LEFT_NSLEEP   17
#define PIN_MOTOR_LEFT_ENABLE   8
#define PIN_MOTOR_LEFT_PHASE    6
#define MOTOR_LEFT_CHANNEL      0

#define PIN_MOTOR_RIGHT_NSLEEP  17
#define PIN_MOTOR_RIGHT_ENABLE  7
#define PIN_MOTOR_RIGHT_PHASE   18
